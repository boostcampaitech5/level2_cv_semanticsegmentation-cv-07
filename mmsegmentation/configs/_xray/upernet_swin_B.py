...
train_pipeline = [
    ...
    dict(type='Resize', scale=(1900,1900)),
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(
        type='AdamW', lr=0.0001, betas=(0.9, 0.999), weight_decay=0.00001),
    paramwise_cfg=dict(
        custom_keys=dict(
...
param_scheduler = [
    dict(
        ...
        by_epoch=False,
        milestones=[14000, 16000, 18000, 20000, 22000, 24000, 26000, 28000, 30000],
        gamma=0.9),
    dict(
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=32000, val_interval=640) #640
...
launcher = 'none'
work_dir = './work_dirs/upernet_swin_B'