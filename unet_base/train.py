...
def parse_args():
    ...
    parser.add_argument("--loss", type=str, default='bce_loss')     ## default bce loss
    
    parser.add_argument("--batch_size", type=int, default=2)
    parser.add_argument("--lr",  type=float, default=0.001)
    parser.add_argument("--resolution", type=int, default=2048)
    parser.add_argument("--grey", type=bool, default=True)         ## using grey scale image(dataset, model)
    parser.add_argument("--nlb", type=bool, default=False)          ## Use non local block or not
...
############## TRAINING SETTINGS 1 ########################
MODEL = 'unet_base_2048_fold0_grey_0615'                    ## exp_name
NAME = MODEL
...
train_dataset = XRayDataset(is_train=True, transforms=tf, fold=FOLD, grey=GREY)
valid_dataset = XRayDataset(is_train=False, transforms=tf, fold=FOLD, grey=GREY)
